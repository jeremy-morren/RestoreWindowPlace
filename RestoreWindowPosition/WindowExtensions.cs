...
public static class WindowExtensions
{
    ...
    /// </code>
    /// </example>
    public static T RestoreWindowPosition<T>(this T window, IWindowPositionStore store)
        where T : Window =>
    ...
    /// <param name="store">Where placements are kept.</param>
    /// <returns>The window, so the call can be chained.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="window"/> or <paramref name="store"/> is <see langword="null"/>.</exception>
    /// <example>
    /// <code>
    ...
    /// </code>
    /// </example>
    public static T RestoreWindowPosition<T>(
        this T window,
        Func<T, WindowPosition, bool>? predicate,
